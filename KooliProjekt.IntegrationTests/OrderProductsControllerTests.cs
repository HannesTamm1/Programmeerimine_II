...
namespace KooliProjekt.IntegrationTests
{
    ...
    public class OrderProductsControllerTests : TestBase
    {
        ...
        public async Task Index_should_return_correct_response()
        {
            ...
            // Act
            using var response = await _client.GetAsync("/TodoLists");
        ...
        public async Task Details_should_return_notfound_when_id_is_missing()
        {
            ...
            // Act
            using var response = await _client.GetAsync("/OrderProducts/Details/");
        ...
        {
            // Arrange
            var list = new OrderProduct { Title = "List 1" };
