...
namespace KooliProjekt.UnitTests.ControllerTests
{
    public class OrderProductsControllerTests
    {
        ...
        public async Task Index_Should_Return_Correct_View_With_Data()
        {
            // Arrange
            int page = 1;
            var search = new OrderProductsSearch();
            var data = new List<OrderProduct>
    {
        ...
        new OrderProduct { Id = 2, Title = "Product 2" }
            ...
            _orderProductServiceMock.Setup(x => x.List(page, It.IsAny<int>(), search)).ReturnsAsync(pagedResult);
            ...
            var model = result.Model as OrderProductsIndexModel;
