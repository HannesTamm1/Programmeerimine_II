...
namespace KooliProjekt.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        {
            var pagedResult = await _context.OrderProducts.GetPagedAsync(page, 5);
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,ProductId,PriceAtOrderTime")] OrderProduct orderProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderId,ProductId,PriceAtOrderTime")] OrderProduct orderProduct)
        {
