...
namespace KooliProjekt.Data
{
    public static class SeedData
    {
        public static void Generate(ApplicationDbContext context)
        {
            ...
            {
                new Order { OrderDate = DateTime.Now, Status = "Processing", UserId = users[0].Id, User = users[0], Title = "Product" },
                new Order { OrderDate = DateTime.Now, Status = "Shipped", UserId = users[1].Id, User = users[1], Title = "Product" }
            };
